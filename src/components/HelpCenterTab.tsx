    ...
    <div className="space-y-6 pb-4 pt-2">
      ...
      <div className="space-y-4 px-2">
        ...
        <div className="neu-card rounded-3xl p-5 flex flex-col items-center text-center space-y-3">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-[0_6px_20px_rgba(34,197,94,0.3)]">
          ...
          <a
            ...
            className="w-full mt-2 py-3.5 bg-green-50 hover:bg-green-100 text-green-700 font-black rounded-2xl border-2 border-green-200 transition-colors flex justify-center items-center gap-2"
          >
        ...
        {/* Telegram Card */}
        <div className="neu-card rounded-3xl p-5 flex flex-col items-center text-center space-y-3">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-[0_6px_20px_rgba(37,99,235,0.3)]">
          ...
          <a
            ...
            className="w-full mt-2 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl shadow-[0_8px_20px_rgba(37,99,235,0.3)] transition-colors flex justify-center items-center gap-2"
          >
